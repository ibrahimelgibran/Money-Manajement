...
import { toast } from "react-toastify"; // add impor toast dari react-toastify
...
function ViewExpenseModal({ show, onClose, expense }) {
  ...
  const deleteExpenseHandler = async () => {
    try {
      ...
      toast.success("Expense category deleted successfully!"); // add message toast for delete dategory
    } catch (error) {
  ...
  const deleteExpenseItemHandler = async (item) => {
    try {
      ...
      toast.success("Expense item deleted successfully!"); // add message toast for delete item outline
    } catch (error) {
      console.log(error.message);
      toast.error(error.message);
    }
